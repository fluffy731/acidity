...
const VENUE_EVENTS = [
  ...
  },
  {
    ...
    dateEnd: '2026-10-11',
    title: 'We Want Miles — Miles Davis Tribute',
    genres: ['Cool / Modal', 'Second Great Quintet', 'Electric'],
    doors: '19:30',
    music: '20:00',
    status: 'ticketed',
    ctaType: 'book',
    ticketUrl: 'https://events.humanitix.com/we-want-miles-miles-davis-tribute',
    poster: 'posters/we-want-miles-portrait.jpg',
    preservePoster: true,
    description: 'A three-night tribute marking 100 years of Miles Davis: three live sets tracing the sound of Kind of Blue, the freedom of the Second Great Quintet and the electricity of the years that followed.',
    lineup: ['Jerry Li — Trumpet', 'Toby — Trumpet', 'Tony Yang — Guitar', 'James Shortland — Bass', 'Zayne Guo — Drums', 'Keys — Special guest to be announced'],
    schedule: ['7:30PM — Doors', '8PM — Music', '11PM — Finish'],
    price: 'Early Bird $25 · General $35',
    generalPrice: '$35',
    earlyBirdPrice: '$25',
    earlyBirdEnds: '2026-10-03T00:00:00+10:00',
    earlyBirdLabel: 'EARLY BIRD ENDS 03 OCT',
    earlyBirdShowEnded: true,
    showDates: ['2026-10-09T20:00:00+11:00', '2026-10-10T20:00:00+11:00', '2026-10-11T20:00:00+11:00'],
    showDurationHours: 3,
    calType: 'feature',
    isPublic: true,
    isFeature: true
