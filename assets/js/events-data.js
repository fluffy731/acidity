...
const VENUE_EVENTS = [
  ...
  },
  {
    ...
    ctaType: 'book',
    ctaLabel: 'Tickets $15 ↗',
    ticketUrl: 'https://events.humanitix.com/brazilian-jazz-and-original-grooves-or-live-music',
  ...
  },
  {
    ...
    ctaType: 'rsvp',
    ctaLabel: 'Free RSVP ↗',
    ticketUrl: 'https://events.humanitix.com/moon-festival-jazz-duo-acidity',
    poster: 'posters/moon-festival-jazz-duo.png',
    preservePoster: true,
    description: 'Yolanda Li and Geryl Leong open with a tribute to Laufey before moving into an R&B-inspired second set shaped by D’Angelo and GIVĒON.',
    lineup: ['Yolanda Li', 'Geryl Leong'],
    schedule: ['8PM — Music', '10PM — Finish'],
    admission: 'Free entry · RSVP recommended.',
    calType: 'session',
    isPublic: true
  },
  {
